...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nocode-ai.git")).toEqual({ owner: "sst", repo: "nocode-ai" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nocode-ai")).toEqual({ owner: "sst", repo: "nocode-ai" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nocode-ai.git")).toEqual({ owner: "sst", repo: "nocode-ai" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nocode-ai")).toEqual({ owner: "sst", repo: "nocode-ai" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nocode-ai.git")).toEqual({ owner: "sst", repo: "nocode-ai" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nocode-ai")).toEqual({ owner: "sst", repo: "nocode-ai" })
})
