...
Practical reference for new and migrated Effect code in `packages/nocode-ai`.
...
export class Service extends Context.Service<Service, Interface>()("@nocode-ai/Foo") {}
