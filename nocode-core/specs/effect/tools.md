...
Practical reference for the current tool-migration state in `packages/nocode-ai`.
...
Tool tests should use the existing Effect helpers in `packages/nocode-ai/test/lib/effect.ts`:
