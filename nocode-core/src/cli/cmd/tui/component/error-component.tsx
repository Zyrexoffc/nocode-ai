...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/nocode-ai/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("nocode-ai-version", InstallationVersion)
