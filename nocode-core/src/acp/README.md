...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for nocode-ai.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal nocode-ai sessions
...
nocode-ai acp --cwd /path/to/project
```
...
```bash
NOCODE_AI_ENABLE_QUESTION_TOOL=1 nocode-ai acp
```
...
- **Terminal Integration**: Full terminal support via nocode-ai's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | nocode-ai acp
```
...
ACP sessions map cleanly to nocode-ai's internal session model:
