  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all NocodeAi sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific NocodeAi session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new NocodeAi session for interacting with AI assistants and managing conversations.",
