...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/nocode-ai/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/nocode-ai...\n")
...
console.log("Fetching npm all-time downloads for nocode-ai-ai...\n")
const npmDownloads = await fetchNpmDownloads("nocode-ai-ai")
