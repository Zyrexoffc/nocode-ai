...
Generates UPCOMING_CHANGELOG.md by running the nocode-ai changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for nocode-ai run (default: low)
      --quiet            Suppress nocode-ai command output unless it fails
